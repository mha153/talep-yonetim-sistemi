...
final class NotificationCenter {
    ...
    static void notifyCustomer(NotificationRepository notificationRepository, Request request,
                                AppUser actor, String message) {
        notify(notificationRepository, request.getCustomer(), request, actor, message);
    }

    static void notifyProductOwner(NotificationRepository notificationRepository, UserRepository userRepository,
    ...
    static void notifyAllDevelopers(NotificationRepository notificationRepository, UserRepository userRepository,
                                     Request request, AppUser actor, String message) {
